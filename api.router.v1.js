...
router.get('/:couponID', auth.tryAuth, coupon.getCouponCodesByCouponID, errorHandler.apiErrorHandler);
router.post('/', couponCodeGenerator.useMobileAndUsernameToCreateCouponCode, coupon.createCouponForNewUser, errorHandler.apiErrorHandler);
