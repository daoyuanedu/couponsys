...
var orderQueryParser = require('./middlewares/orderQueryParser');
...
router.get('/orders/:orderId', auth.tryAuth, couponOrder.getOrderByOrderId, errorHandler.apiErrorHandler);
